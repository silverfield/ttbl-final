...
#define TD_USPORA_NAME "uspora"

#define TD_USPORA_SET "-set"
...
class TdUspora: public TdOracle {
private:
	//----- data -----
	TdGraph *cGraph;
	UgGraph *cUgGraph;
...
public:
	//----- Constructors -----
	TdUspora(std::vector<std::string> iArguments);
	~TdUspora();
	...
	static inline std::string fSGetName() {return TD_USPORA_NAME;};
